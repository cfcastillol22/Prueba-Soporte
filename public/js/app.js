  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapActions)(['fetchTasks', 'fetchUsers', 'addTask', 'completeTask', 'deleteTask'])), {}, {
    addTask: function addTask() {
      ...
      this.$store.dispatch('addTask', this.newTask).then(function () {
        ...
        if (error.response && error.response.data && error.response.data.errors) {
          var errorMessages = Object.values(error.response.data.errors).flat().join(', ');
          _this.errors = errorMessages;
        } else {
          _this.errors = 'Error agregando la tarea.';
        }
      });
    },
    completeTask: function completeTask(taskId) {
      ...
      this.$store.dispatch('completeTask', taskId)["catch"](function (error) {
        var _error$response;
        _this2.errors = ((_error$response = error.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || 'Error completando la tarea';
      });
    },
...
var render = function render() {
  ...
  }, [_vm._v("Task List")]), _vm._v(" "), _vm.errors ? _c("div", {
